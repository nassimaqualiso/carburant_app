...
export default defineComponent({
  ...
  methods: {
    ...
    getDataCarId(){
      return ApiService.get("datacar/"+ this.id)
        .then(({ data }) => {
          const datacar = data.data;
          this.brandValue = datacar.vehicle_brand_id;
          this.onSelectBrand(this.brandValue);
          this.modelValue = datacar.vehicle_model_id;
          this.energyValue = datacar.vehicle_energy_id;
          this.periodValue = datacar.vehicle_period_id;
          this.lengthValue = datacar.vehicle_length_id;
        })
        .catch(({ error }) => {
          console.log(error);
        });
    ...
    update(datacar) {
      return ApiService.put("datacar/" + this.id, datacar)
        .then(({ data }) => {
          this.isLoading = false;
          Swal.fire({
            position: "top-end",
