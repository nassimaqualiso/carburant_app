            ...
            <div class="modal-body">
              ...
              <div class="col-md-12 mb-5">
                ...
                <Multiselect
                  ...
                  :searchable="true"
                  :create-option="true"
                  :options="pluckedBrands"
                />
                <div class="fv-plugins-message-container">
                  <div class="fv-help-block">
                    <span v-if="otherErrors.brandValue" class="text-danger"
...
export default defineComponent({
  ...
  computed: {
    pluckedBrands() {
      return hlpFn_pluck(this.brands, "id", "name");
    },
  },
  methods: {
    getDataListing() {
      this.$emit("getDataListing", "vehicle_models");
    },
    ...
    getDataElement(value) {
      return ApiService.get(this.moduleName + "/" + value)
        .then(({ data }) => {
          ...
          this.brandValue = data.data.vehicle_brand_id;
          console.log("models ot edited", data);
        })
        .catch(({ error }) => {
          console.log(error);
          this.isModalLoading = false;
      ...
      return ApiService.post(this.moduleName, element)
        .then(({ data }) => {
          if (data.success) {
            ...
            this.isModalLoading = false;
            this.$refs.modelDataTable.getDataListing();
            Swal.fire({
              position: "top-end",
              icon: "success",
        ...
        .catch(({ error }) => {
          ...
          //   position: "top-end",
          //   icon: "error",
          //   title: "model failed to be created",
          //   showConfirmButton: false,
          //   timer: 1500,
          // });
        });
    ...
    getBrands(param = "") {
      return ApiService.get("vehicle_brands")
        .then(({ data }) => {
    ...
    valideteData() {
      this.otherErrors.brandValue = !this.brandValue ? true : false;
