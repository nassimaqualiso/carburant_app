<template>
  ...
  >
    <template v-slot:create_button>
      <button
        ...
        data-bs-target="#productCategoryCreate"
      >
  ...
  <!-- start modal create -->
  <div class="modal fade" tabindex="-1" id="productCategoryCreate">
    <div class="modal-dialog">
      <div class="modal-content">
        <VForm @submit="OnCategorySubmit" :validation-schema="category">
...
export default defineComponent({
  ...
  methods: {
    ...
    store(category) {
      return ApiService.post("product-categories", category)
        .then(({ data }) => {
          console.log("Category store respose");
