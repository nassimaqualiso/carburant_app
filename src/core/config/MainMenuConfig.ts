...
const MainMenuConfig: Array<MenuItem> = [
    ...
    pages: [
      {
        ...
        fontIcon: "bi bi-person-workspace",
      },
  ...
  },
  {
    ...
    pages: [
      ...
      {
        heading: "Packs",
        route: "/articles/packs",
        svgIcon: getAssetPath("media/icons/duotune/general/gen014.svg"),
        fontIcon: "bi bi-boxes",
      },
      {
        heading: "Sale Prices",
        route: "/articles/sale_prices",
        svgIcon: getAssetPath("media/icons/duotune/general/gen014.svg"),
  ...
  },
  {
    ...
    pages: [
      {
        heading: "Datacar",
        route: "/garage/datacar",
        svgIcon: getAssetPath("media/icons/duotune/general/gen014.svg"),
        fontIcon: "bi bi-car-front-fill",
      },

      {
        ...
        svgIcon: getAssetPath("media/icons/duotune/general/gen014.svg"),
        fontIcon: "bi bi-truck-front-fill",
