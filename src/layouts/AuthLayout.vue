<template>
  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <!--begin::Aside-->
    <div
      class="bg-dark d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
    >
      <!--begin::Content-->
      <div
      ...
      >
        ...
        <router-link to="/" class="mb-0 mb-lg-12">
          <img
            alt="Logo"
            src="https://fv-cdn-prod-endpoint.azureedge.net/Custom/fv-logo.svg"
